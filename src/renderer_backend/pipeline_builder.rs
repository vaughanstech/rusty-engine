...
impl PipelineBuilder {
    ...
    pub fn build_pipeline(&self, device: &wgpu::Device) -> wgpu::RenderPipeline {
        ...
        // Pipeline layout
        // 1. Bind Groups: Large long-term resources which persist for the lifetime of the draw call
        // 2. Push Constants: A quick way to get data into a render pass (the data is live)
